 ...
 * @since 2020-12-03
 */
@Api(value = "讲师管理", description = "讲师管理")
@RestController
...
public class EduTeacherController {
    ...
    @ApiOperation(value = "/findAll", notes = "查询所有讲师")
    @GetMapping("/findAll")
    ...
    @ApiOperation(value = "/{id}", notes = "根据id删除讲师")
    @DeleteMapping("{id}")
    ...
    @ApiOperation(value = "/getPageTeacher/{current}/{limit}", notes = "分页查询讲师")
    ...
    @ApiOperation(value = "/getQueryTeacher/{current}/{limit}", notes = "多条件组合分页查询")
    ...
    @ApiOperation(value = "/addTeacher", notes = "添加讲师")
    ...
    @ApiOperation(value = "getTeacher/{id}", notes = "根据id查询讲师")
    ...
    @ApiOperation(value = "/updateTeahcer", notes = "修改讲师")
